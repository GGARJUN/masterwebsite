    ...
    return (
        <header
            ...
            className={`fixed w-full top-0 px-4 sm:px-6 lg:px-8 z-50 transition-all duration-700 ease-in-out ${isScrolled
                    ? "bg-gradient-to-r from-purple-700/80 via-indigo-700/80 to-pink-700/80 backdrop-blur-md rounded-xl max-w-7xl mx-auto ml-14 shadow-[0_8px_32px_rgba(0,0,0,0.2)] mt-4"
                    : "bg-gradient-to-r from-purple-700 via-indigo-700 to-pink-700 shadow-md"
                }`}
        >
