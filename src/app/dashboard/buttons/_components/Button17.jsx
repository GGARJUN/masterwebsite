    ...
    <div className="w-full p-10 bg-white rounded-3xl shadow-2xl">
      ...
      <div className="flex flex-col md:flex-row justify-center w-full items-center gap-16">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <button
            className="group relative overflow-hidden rounded px-8 py-3 h-12 text-sm font-semibold bg-teal-700 text-white shadow-md hover:shadow-2xl transition-all duration-400"
          >
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <button
            className="group relative overflow-hidden rounded-lg px-8 py-3 h-12 text-sm font-semibold bg-indigo-700 text-white shadow-md focus:shadow-2xl transition-all duration-400 focus:outline-none"
          >
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <button
            className="group relative overflow-hidden rounded-xl px-8 py-3 h-12 text-sm font-semibold bg-red-700 text-white shadow-md transition-all duration-200"
          >
            <div className="relative z-10 flex items-center justify-between">
              <span>Press Me</span>
              <Zap
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <button
            className="group relative overflow-hidden rounded-3xl px-8 py-3 h-12 text-sm font-semibold bg-lime-600 text-white shadow-md"
          >
            <div className="relative z-10 flex items-center justify-between">
              <span>Animated</span>
              <Rocket
