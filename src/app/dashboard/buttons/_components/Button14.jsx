    ...
    return (
      ...
      <div className="flex flex-col md:flex-row justify-evenly w-full items-center gap-8">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <button className="relative overflow-hidden bg-gradient-to-br from-indigo-600 to-purple-600 text-white h-12 px-8 rounded-2xl font-medium shadow-md hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 group">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <button className="relative bg-gradient-to-br from-blue-600 to-cyan-500 text-white h-12 px-8 rounded-2xl font-medium shadow-md focus:outline-none focus:ring-4 focus:ring-green-300 focus:scale-105 transition-all duration-200">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <button className="relative bg-gradient-to-br from-emerald-600 to-teal-500 text-white h-12 px-8 rounded-2xl font-medium shadow-md active:scale-95 active:shadow-sm transition-transform duration-150">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <button className="relative overflow-hidden bg-gradient-to-br from-rose-600 to-pink-600 text-white h-12 px-8 rounded-2xl font-medium shadow-md animate-glow hover:animate-none">
